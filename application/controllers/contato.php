...
class Contato extends CI_Controller{
    ...
    public function index(){
        ...
        if($this->input->post('enviar_email') == "enviar"){			
            ...
            $this->email->from("atendimento@digimobi.com.br","$nome"); //senha: 
            $this->email->to('atendimento@digimobi.com.br');
            ...
            if($this->email->send()){				
                redirect('http://digimobi.com.br/m4k-teste/contato/obrigado');
            }else{
                redirect('http://digimobi.com.br/m4k-teste/contato/fail');
            }
